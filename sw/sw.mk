...
ifneq (,$(filter chs-sw% snrt% pb-snrt-tests% sw,$(MAKECMDGOALS)))
...
sw sw-tests: chs-sw-tests snrt-tests pb-snrt-tests

sw-clean sw-tests-clean: chs-sw-tests-clean clean-snrt-tests clean-pb-snrt-tests
