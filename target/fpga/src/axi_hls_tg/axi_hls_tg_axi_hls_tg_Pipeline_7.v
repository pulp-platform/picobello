...
module axi_hls_tg_axi_hls_tg_Pipeline_7 (
        ap_clk,
        ap_rst,
        ap_start,
        ap_done,
...
input  [63:0] narrow_buffer_V_q0;

reg ap_idle;
reg m_axi_narrow_port_WVALID;
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        ...
        narrow_buffer_V_load_reg_140 <= narrow_buffer_V_q0;
    end
end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (ap_enable_reg_pp0_iter2 == 1'b1))) begin
        m_axi_narrow_port_WVALID = 1'b1;
    end else begin
        m_axi_narrow_port_WVALID = 1'b0;
    end
end
...
always @ (*) begin
    ap_block_pp0_stage0_11001 = ((m_axi_narrow_port_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end

always @ (*) begin
    ap_block_pp0_stage0_subdone = ((m_axi_narrow_port_WREADY == 1'b0) & (ap_enable_reg_pp0_iter2 == 1'b1));
end
...
assign m_axi_narrow_port_RREADY = 1'b0;

assign m_axi_narrow_port_WDATA = narrow_buffer_V_load_reg_140;

assign m_axi_narrow_port_WID = 1'd0;

assign m_axi_narrow_port_WLAST = 1'b0;

assign m_axi_narrow_port_WSTRB = 8'd255;
